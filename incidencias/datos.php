...
if (isset($_GET['opcion'])) {
    ...
    $query = "SELECT * FROM " . $opcion . " order by fecha desc limit 20";
    ...
    $query = 'SELECT libros.Id_libro as Id_libro,libros.Titulo,' . $opcion . '.cantidad as cantidad FROM ' . $opcion . ' LEFT JOIN libros on libros.Id_libro=' . $opcion . '.titulo WHERE Id_h' . $campo . '="' . $orden . '" and libros.Activo=1 order by Id_' . $campo . ' asc';
    //echo $query;
