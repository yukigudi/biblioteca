                    ...
                    <div id="lineas">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 col-lg-3 mb-3">
                                <label for="testigo">Usuario que envió</label>
                                <select id="usuario_envio" name="usuario_envio" class="form-control" required>
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            <div class="col-md-6 col-lg-3 mb-3">
                                <label for="testigo">Usuario que recibió</label>
                                <select id="usuario_recibio" name="usuario_recibio" class="form-control" required>
                                    <option value="">Selecciona</option>
                                    <?php 
                        ...
                        <div class="form-row envios">
                            <div class="col-md-12 col-lg-12 mb-4">
                                ...
                                <textarea class="form-control" rows="5" id="incidencia" name="incidencia"></textarea>
            ...
            if (isset($_POST['registrar'])) {
               ...
               /* $modulos = $_POST['modulos'];
                $cantidad = $_POST['cantidad'];*/
                            ...
                            $query = "INSERT INTO incidencias (fecha,usuario,fechaenvio,fecharecibido,usuarioenvio,usuariorecibio,testigo,incidencia) values('$fecha',$usuario,'$fechaenvio','$fecharecibido',$usuarioenvio,$usuariorecibio,'$testigo','$incidencia')";
                ...
                if ($verificar) {
                    ...
                    confirmButtonText: "Registrar otra incidencia",
