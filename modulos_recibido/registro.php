...
<body>
                ...
                <form class="p-4 needs-validation" action="registro.php" method="POST" novalidate>
                    <div id="lineas">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 col-lg-3 mb-4">
                                <label for="validationCustom02">Enviar a</label>
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            <div class="col-md-5 col-lg-5 mb-5 text-right">
                                <label style="font-weight:bold;" for="incidencias"><a
                                        href="../incidencias/registrar_incidencias.php" target="_blank">Registrar
                                        incidencia</label>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        if ($resultado->num_rows > 0) {
                            ...
                            <div class="col-md-6 col-lg-3 mb-4">
                                <label for="cantidad">¿Recibió completo?</label>
                                <div class="form-row">
                                    <div class="col-md-6 col-lg-3 mb-4" style="margin-left:30px">
                                        <input type="radio" class="form-check-input" name="recibio_completo" value="1">
                                        <label for="cantidad">Si</label>
                                    </div>
                                    <div class="col-md-6 col-lg-3 mb-4">
                                        <input type="radio" class="form-check-input" name="recibio_completo" value="0">
                                        <label for="cantidad">No</label>
                                    </div>
                                </div>
                            </div>
                ...
                $fecha=date("Y-m-d H:i:s");
                    ...
                    if (isset($modulos) AND is_array($modulos)) {
                        ...
                        foreach($modulos as $key => $value) {
                            ...
                            $query = "INSERT INTO recibido_modulos (fecha,usuario,ubicacion,envioa,fecharecibo,recibe,testigo,titulo,cantidad) values('$fecha',$usuario,'$ubicacion','$envioa','$fecha_actual',$recibe,'$testigo',$value,$cantidad[$key])";

                            //$query = "INSERT INTO recibido_modulos (ubicacion,envioa,fechaenvio,recibe,testigo,titulo,cantidad) values('$ubicacion','$envioa','$fecha_actual',$recibe,'$testigo',$value,$cantidad[$key])";
    ...
    function agregarLinea() {
        var $c = $('.envios').length;
        $('#lineas').append(
            ' <div class="form-row envios"><div class="col-md-6 col-lg-6 mb-4"><select id="modulos[]" name="modulos[]" class="form-control" required><option value="">Selecciona</option><?php $query="SELECT * FROM libros"; $resultado=$conexion->query($query);if ($resultado->num_rows > 0) {while ($fila=$resultado->fetch_assoc()) { ?><option value="<?php echo$fila['Id_libro']; ?>"><?php echo$fila['Titulo']; ?></option><?php }}?></select><div class="valid-feedback">Correcto!</div><div class="invalid-feedback">Porfavor rellena el campo.</div></div><div class="col-md-6 col-lg-3 mb-4"><input type="text" class="form-control" id="cantidad[]" name="cantidad[]"><div class="valid-feedback">Correcto!</div><div class="invalid-feedback">Porfavor rellena el campo.</div></div><div class="col-md-6 col-lg-3 mb-4"><div class="form-row"><div class="col-md-6 col-lg-3 mb-4" style="margin-left:30px"><input type="radio" class="form-check-input" name="recibio_completo' +
            $c +
            '" value="1"> <label for="cantidad">Si</label></div><div class="col-md-6 col-lg-3 mb-4"><input type="radio" class="form-check-input" name="recibio_completo' +
            $c + '" value="0"> <label for="cantidad">No</label></div></div></div></div>'
        );
