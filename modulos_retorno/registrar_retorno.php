        ...
        <div class="container">
            ...
            <div class="bg-white rounded-lg formulario">
                <form class="p-4 needs-validation" action="registrar_libros.php" method="POST" novalidate>
                    <center><label for="">
                            <h4>REGISTRAR RETORNO DE LIBROS</h4>
                        </label></center>
                    <div class="form-row">
                    <div class="col-md-6 col-lg-3 mb-4">
                        ...
                        <div class="col-md-6 col-lg-4 mb-3">
                            <label for="validationCustom04">Fecha actual</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 col-lg-3 mb-4"><i class="icofont-plus-square"></i> Agregar linea de captura
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="col-md-6 col-lg-3 mb-4">
                            <label for="validationCustom02">Modulo</label>
                            <select id="validationCustom02" name="ubicacion_actual" class="form-control" required>
                                <option value="bodega_chica">Bodega chica</option>
                                <option value="bodega_grande">Bodega grande</option>
                            </select>
                        ...
                        <div class="col-md-6 col-lg-3 mb-4">
                            ...
                            <input type="text" class="form-control" id="validationCustom04" name="cantidad">
                            <div class="valid-feedback">
                                Correcto!
                            </div>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 col-lg-3 mb-3">
                            <label for="validationCustom04">Recibe</label>
                            <select id="validationCustom02" name="ubicacion_actual" class="form-control" required>
                                <option value="plazas">Plazas</option>
                                <option value="municipio">Municipio</option>
                            </select>
                        ...
                        <div class="col-md-6 col-lg-3 mb-3">
                            <label for="validationCustom04">Testigo</label>
                            <input type="text" class="form-control" id="validationCustom04" name="testigo">
                            <div class="valid-feedback">
                                Correcto!
                            </div>
                            <div class="invalid-feedback">
