...
//Setting name
$today = date("Ymd");
$filename = "reporte_detalleasignacion";
...
$titulo = ' Detalle de asignacion ' . $dato;
...
$sheet->setCellValue('B' . $filaFin+7, 'Responsable entrega');
$sheet->setCellValue('D' . $filaFin+7, 'Responsable recibe');
