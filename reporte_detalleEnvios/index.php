...
// Salto de línea
$pdf->Ln(20);
$pdf->Cell(100, 10, 'Detalle de Envio Numero ' . $dato . ' - ' . date("d/m/Y, g:i a"), 0, 0, 'C');
$pdf->Ln(20);
...
$pdf->Cell(90, 0, mb_convert_encoding($firma['nombre_usuario1'], 'ISO-8859-1', 'UTF-8'));
$pdf->Cell(90, 0, mb_convert_encoding($firma['nombre_usuario2'], 'ISO-8859-1', 'UTF-8'));
$pdf->Cell(90, 0, mb_convert_encoding('', 'ISO-8859-1', 'UTF-8'));
$pdf->Ln(5);
// imprimir la tercera línea de firma
$pdf->Cell(90, 0, 'Responsable de entrega');
$pdf->Cell(90, 0, 'Coordinador de zona');
