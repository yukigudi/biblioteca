...
$pdf->Image('../images/logo1.png',10,8,20);
    ...
    $pdf->cell(65,10,'Usuario',1,0,'C',0);
    $pdf->cell(17,10,'Fecha envio',1,0,'C',0);
    $pdf->cell(38,10,'Fecha recibio',1,0,'C',0);
    $pdf->cell(38,10,'Usuario que envia',1,0,'C',0);
    $pdf->cell(38,10,'Usuario que recibe',1,0,'C',0);
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->cell(15,10,$row['usuario'],1,0,'C',0);
    $pdf->cell(15,10,$row['fechaenvio'],1,0,'C',0);
    $pdf->cell(15,10,$row['fecharecibido'],1,0,'C',0);
    $pdf->cell(15,10,$row['usuarioenvio'],1,0,'C',0);
    $pdf->cell(15,10,$row['usuariorecibio'],1,0,'C',0);
    $pdf->cell(15,10,$row['testigo'],1,0,'C',0);
    $pdf->cell(15,10,$row['incidencia'],1,0,'C',0);
