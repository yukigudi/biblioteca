  ...
  <body>
                              ...
                              <?php
                                ...
                                ?>
                                  <tr class='text-center'>
                                      <td><small><?php echo $fila['Id_hasignacion']; ?></small></td>
      ...
      <script language="javascript">
          function detalleEnvios(id) {
              $filtros = "?id=" + id;
              window.open("/biblioteca/reportes/detalle_asignaciones.php" + $filtros, "Detalle de Asignaciones", "directories=no location=no");
          }
      </script>
