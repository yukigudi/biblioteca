  ...
  <body>
                              ...
                              <?php
                                ...
                                ?>
                                  <tr class='text-center'>
                                      <td><small><?php echo $fila['Id_hretorno']; ?></small></td>
                                      <td><small><?php echo $fila['ubicacion']; ?></small></td>
      ...
      <script type="text/javascript">
          $(document).ready(function() {
              ...
              $("#btnDescargarxls").click(function() {
                  ...
                  var url = "/biblioteca/phpxsls/ReportesXls/PhpOffice/reporte_devoluciones.php" + $filtros;
                  ...
                  $('<a>').attr({
                      href: url,
                      download: 'reporte_devoluciones.xlsx'
                  })[0].click();
      ...
      <script language="javascript">
          function detalleEnvios(id) {
              $filtros = "?id=" + id;
              window.open("/biblioteca/reportes/detalle_devoluciones.php" + $filtros, "Detalle de Devoluciones", "directories=no location=no");
          }
      </script>
      ...
      <script>
          function abrirReporteEnvios() {
              ...
              console.log($filtros);
              window.open("/biblioteca/reporte_devoluciones/index.php" + $filtros, "Reporte de Devoluciones", "directories=no location=no");
