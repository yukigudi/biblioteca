...
<body>
    ...
    <script language="javascript">
        function confirmar(id) {
            swal({
                    title: "Advertecia!",
                    text: "¿Esta seguro de eliminar la Coordinación de zona?",
                    type: "warning",
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        ...
                        swal({
                            ...
                            text: "La Coordinación de zona no fue eliminada",
                            type: "error",
                            confirmButtonClass: "btn-primary",
    ...
    <script>
        function abrirReportelibros() {
            ...
            console.log($filtros);
            window.open("../reporte_cordzona/index.php" + $filtros, "Reporte de ubicaciones", "directories=no location=no");
        }

        /*  function abrirReportexls() {
              $dato = $('#dato').val();
              $tipo = "cz";
              $filtros = "?dato=" + $dato + "&tipo=" + $tipo;
              console.log($filtros);
              window.open("../reportesxls/reporte_ubicaciones_cordzona.php" + $filtros, "Reporte de ubicaciones", "directories=no location=no");
