  ...
  <body>
                               ...
                               /* if ($filtro) {
                                ...
                                ?>
                                  <tr class='text-center'>
                                      ...
                                      <td class="text-right"><a class="bg-primary py-1 rounded-lg" href="modificar.php?ubic=delegacion&id=<?php echo $fila['Id_ubicacion'] ?>"><span class='h6 text-white icofont-ui-edit px-1'></small></a></td>
      ...
      <script type="text/javascript">
          $(document).ready(function() {
              ...
              $("#btnDescargarxls").click(function() {
                ...
                var url = "/biblioteca/phpxsls/ReportesXls/PhpOffice/reporte_ubicaciones_delegaciones.php" + filtros;
                ...
                $('<a>').attr({
                    href: url,
                    download: 'reporte_ubicaciones_delegaciones.xlsx'
                })[0].click();
      ...
      <script language="javascript">
          function confirmar(id) {
              swal({
                      title: "Advertecia!",
                      text: "¿Esta seguro de eliminar la Delegación?",
                      type: "warning",
                  ...
                  function(isConfirm) {
                      if (isConfirm) {
                          window.location = "eliminar_delegacion.php?id=" + id;
                      } else {
                          swal({
                              title: "Operación cancelada!",
                              text: "La Delegación no fue eliminada",
                              type: "error",
                              confirmButtonClass: "btn-primary",
      ...
      <script>
          function abrirReportelibros() {
              ...
              console.log($filtros);
              window.open("../reporte_delegaciones/index.php" + $filtros, "Reporte de ubicaciones", "directories=no location=no");
