                ...
                <form class="p-4 needs-validation" action="realizar_edicion.php?id=<?php echo $fila['Id_ubicacion'] ?> method="POST" novalidate>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3 mb-3">
                            ...
                            <input type="text" class="form-control" id="cod_pos" required name="cod_pos" placeholder="Código postal" pattern="[a-zA-Z0-9àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="10" value="<?php echo $fila['codigo_postal']; ?>">
                            <div class="valid-feedback">
                                Correcto!
                            </div>
                            <div class="invalid-feedback">
