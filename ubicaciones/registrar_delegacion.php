  ...
  <div class="wrapper">
    ...
    <div class="container">
      ...
      <div class="bg-white rounded-lg formulario">
        <form class="p-4 needs-validation" action="registrar_delegacion.php" method="POST" novalidate>
          <center><label for="">
              <h4>REGISTRAR DELEGACION</h4>
            </label></center>
          <div class="form-row">
  ...
  if (isset($_POST['registrar'])) {
    ...
    if ($verificar) {
      echo '<script>
                    ...
                    text: "La Delegación fue registrada correctamente!",
                    type: "success",
                    showCancelButton: true,
                    cancelButtonClass: "btn-warning",
                    cancelButtonText: "Registrar",
                    confirmButtonClass: "btn-success",
                    confirmButtonText: "Ver Delegación",
                  ...
                  function(isConfirm) {
                      if (isConfirm) {
                        ...
                        window.location="registrar_delegacion.php";
                      }
                    });
                    </script>';
    } else {
      echo '<script>
                    ...
                    text: "Ocurrio un error al registrar la Delegación!",
                    type: "error",
                    showCancelButton: true,
                    cancelButtonClass: "btn-warning",
                    cancelButtonText: "Intentar de nuevo",
                    confirmButtonClass: "btn-success",
                    confirmButtonText: "Ver Delegaciones",
                    closeOnConfirm: false
                  },
                  function(isConfirm) {
                      if (isConfirm) {
