  ...
  <div class="wrapper">
    ...
    <div class="container">
      ...
      <div class="bg-white rounded-lg formulario">
        <form class="p-4 needs-validation" action="registrar_ubicacionresguardo.php" method="POST" novalidate>
          <center><label for="">
              <h4>REGISTRAR UBICACION DE RESGUARDO</h4>
            </label></center>
          <div class="form-row">
  ...
  if (isset($_POST['registrar'])) {
    ...
    if ($verificar) {
      echo '<script>
                    ...
                    text: "La Ubicación de resguardo fue registrada correctamente!",
                    type: "success",
                    showCancelButton: true,
                    cancelButtonClass: "btn-warning",
                    cancelButtonText: "Registrar",
                    confirmButtonClass: "btn-success",
                    confirmButtonText: "Ver Ubicaciones de resguardo",
      ...
      echo '<script>
                    ...
                    text: "Ocurrio un error al registrar la Ubicación de resguardo!",
                    type: "error",
                    showCancelButton: true,
                    cancelButtonClass: "btn-warning",
